...
CREATE TABLE IF NOT EXISTS `kependudukan`.`KartuKeluarga` (
  ...
  PRIMARY KEY (`Id`, `RTId`),
  INDEX `fk_KartuKeluarga_RT1_idx` (`RTId` ASC),
...
CREATE TABLE IF NOT EXISTS `kependudukan`.`KKDetail` (
  ...
  `Id` INT(11) NOT NULL AUTO_INCREMENT,
  INDEX `fk_KKDetail_KartuKeluarga1_idx` (`KartuKeluargaId` ASC),
  INDEX `fk_KKDetail_Penduduk1_idx` (`PendudukId` ASC),
  INDEX `fk_KKDetail_PendudukDetail1_idx` (`Id` ASC),
  PRIMARY KEY (`Id`),
  CONSTRAINT `fk_KKDetail_KartuKeluarga1`
    FOREIGN KEY (`KartuKeluargaId`)
    REFERENCES `kependudukan`.`KartuKeluarga` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_KKDetail_Penduduk1`
    FOREIGN KEY (`PendudukId`)
    REFERENCES `kependudukan`.`Penduduk` (`Id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
